...
import com.amqo.forecastapp.data.db.LocalDateConverter
import com.amqo.forecastapp.internal.DateNotFoundException
...
class FutureDetailWeatherFragment : ScopedFragment(), KodeinAware {
    ...
    private fun bindUI() = launch(Dispatchers.Main) {
        ...
        consume(viewModel.weather, { weatherEntry ->
